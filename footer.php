    <footer class="site-footer">
        <div class="container">
            ...
            <p>相关侵权、举报、投诉及建议等，请发邮件至E-mail：ddys@aluckymickey.eu.org</p>
            ...
            <div class="Copyright flex">
                <span>Copyright <script>document.currentScript.insertAdjacentHTML('afterEnd',new Date().getFullYear())</script> <a href="<?php bloginfo('url');?>"><?php echo get_bloginfo('name')?></a>&nbsp;&nbsp;<a rel="nofollow" target="_blank" href="http://beian.miit.gov.cn">浙ICP备202007151145号</a></span>
